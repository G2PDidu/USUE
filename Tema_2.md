...
1. `print(211 + 412)`: Выводится выводится операция сложения двух переменных типа int. 

2. `print(6.1 - 1.7)`: Выводится выводится операция вычетания двух переменных типа float.

3. `print(9 - 1.1 + 3 - 2.12)`: Выводится число с плавающей точкой 2.077.
- Текст задания
- Оформленный код
- Скрины консоли
- Краткие Выводы
