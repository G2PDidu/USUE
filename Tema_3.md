...
1. `print('Переменная меньше 0')`: Выводится . 

2. ` print('Переменная больше 0 и меньше 10')`: Выводится .

3. `print('Переменная больше 10')`: Выводится .
...
1. `print('Переменная есть в данном массиве')`: Выводится строка. 

2. `print('Переменной нет в этом массиве')`: Выводится результат с использованием заранее объявленной переменной.
