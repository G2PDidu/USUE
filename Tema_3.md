...
1. `print('Выполняется')`: Выводится . 

2. `print('НЕ Выполняется')`: Выводится .
...
1. `print('Переменная меньше 0')`: Выводится результат операции сложения двух переменных типа int. 

2. ` print('Переменная больше 0 и меньше 10')`: Выводится результат операции вычетания двух переменных типа float.

3. `print('Переменная больше 10')`: Выводится результат операции сложения и вычетания двух переменных типа int и float.
